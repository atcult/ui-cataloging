...
import TemplateDetailTag from './Template/edit/section/TemplateDetailTag';
  ...
  render() {
    ...
    return (
      <Switch>
        ...
        <ConnectedRoute path={`${rootPath}/templateList/%{id}`} {...this.props} component={TemplateDetailTag} id="template_details_nav_root" />
        <ConnectedRoute path={`${rootPath}/templateList/edit/%{id}`} {...this.props} component={EditTemplate} id="template_edit_nav_root" />
